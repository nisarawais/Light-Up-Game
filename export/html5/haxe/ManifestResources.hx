...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_orange_tile_no_score_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_dark_red_brick_no_score_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_light_brown_tile_no_score_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_brown_tile_no_score_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/images/orange_tile_no_score.png") @:noCompletion #if display private #end class __ASSET__assets_images_orange_tile_no_score_png extends lime.graphics.Image {}
...
@:keep @:image("assets/images/dark_red_brick_no_score.png") @:noCompletion #if display private #end class __ASSET__assets_images_dark_red_brick_no_score_png extends lime.graphics.Image {}
@:keep @:image("assets/images/light_brown_tile_no_score.png") @:noCompletion #if display private #end class __ASSET__assets_images_light_brown_tile_no_score_png extends lime.graphics.Image {}
...
@:keep @:image("assets/images/brown_tile_no_score.png") @:noCompletion #if display private #end class __ASSET__assets_images_brown_tile_no_score_png extends lime.graphics.Image {}
